      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
        <div className="order-2 md:order-1">
          <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl mb-4">
            <span className="text-primary">Data Scientist</span> & <span className="text-emerald-500">Geospatial AI Expert</span>
          </h1>
          <p className="text-lg mb-6">
            A passionate data scientist with <span className="font-bold">4+ years of experience</span> developing AI-driven solutions for urban planning, hydrology automation, and large-scale geospatial analysis.
          </p>
          <div className="flex flex-wrap gap-3 mb-8">
            <span className="bg-blue-100 text-primary py-1 px-3 rounded-full text-sm font-medium">Python</span>
            <span className="bg-green-100 text-emerald-600 py-1 px-3 rounded-full text-sm font-medium">Machine Learning</span>
            <span className="bg-amber-100 text-amber-600 py-1 px-3 rounded-full text-sm font-medium">BigQuery</span>
            <span className="bg-indigo-100 text-indigo-600 py-1 px-3 rounded-full text-sm font-medium">Geospatial AI</span>
            <span className="bg-purple-100 text-purple-600 py-1 px-3 rounded-full text-sm font-medium">NLP</span>
          </div>
